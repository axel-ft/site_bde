            ...
            <div class="col-lg-12">
                <div class="card card-hero card-primary animated fadeInUp animation-delay-7">
                    <div class="card-block">
                        <h1 class="color-primary text-center">Ajouter une association</h1>
                        ...
                        <form method="POST" action="/manage/assos/add" enctype="multipart/form-data">
                            <fieldset>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group label-floating">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name_asso" id="name_asso" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group label-floating">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description_asso" id="description_asso" class="form-control" rows="4" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group label-floating">
                                    <div class="input-group">
                                        ...
                                        <input type="text" readonly="true" class="form-control" placeholder="Logo de l'association - Parcourir... *">
                            ...
                            <button class="btn btn-raised btn-primary btn-block" type="submit">Ajouter une association<i class="zmdi zmdi-long-arrow-right no-mr ml-1"></i></button>
                        </form>
                    </div>
                </div>
            </div>
